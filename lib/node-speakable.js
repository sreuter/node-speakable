...
var Speakable = function Speakable(lang) {
  EventEmitter.call(this);

  this.recBuffer = [];
  this.recRunning = false;
  this.apiResult = {};
  this.apiLang = lang || "en-US";
...
Speakable.prototype.parseResult = function() {
  var spokenWords = [], apiResult = this.apiResult;
  if(apiResult.hypotheses[0]) {
    spokenWords = apiResult.hypotheses[0].utterance.split(' ');
    this.emit('speechResult', spokenWords);
  } else {
